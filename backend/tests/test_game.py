...
class TestGameState:
    def test_valid_initial_state(self, seeded_game_42_waiting, first_click_coordinates_seeded_game_42):
        game = seeded_game_42_waiting

        assert game.state == GameState.WAITING

        game.start(
            first_click_coordinates_seeded_game_42["x"],
            first_click_coordinates_seeded_game_42["y"]
        )
    ...
    def test_loose_condition(self, seeded_game_42_playing):
    ...
    def test_win_condition(self, seeded_game_42_playing):
        won_game = seeded_game_42_playing
    ...
    def test_flag(self, seeded_game_42_playing):
    ...
    def test_to_dict_won(self, seeded_game_42_playing):
        won_game = seeded_game_42_playing
